...
if __name__ == "__main__":
    ...
    parser.add_argument("--crop_size", type=int, default=96, help="Override default lateral patch size")
    parser.add_argument("--crop_depth", type=int, default=24, help="Override default axial patch size")
    parser.add_argument("--scale", type=int, default=1)
    parser.add_argument("--scale_axial", type=int, default=1)
    ...
    # 初始化模型
    model = RestorationNetwork3d_subback2(scale=scale, scale_axial=scale_axial, num_features=num_features, back_features=back_features, back_flag=back_flag,
