...
class ResidualBlockWithSE(nn.Module):
    ...
    def __init__(self, channels, reduction=16):
        super().__init__()
        self.conv1 = BasicConv3d(channels, channels, kernel_size=3)
        self.conv2 = BasicConv3d(channels, channels, kernel_size=3)
...
class Transmittance(nn.Module):
    ...
    def __init__(self, in_channels, base_features=24, num_residual_blocks=2):
        ...
        self.initial_mapping = nn.Conv3d(in_channels, base_features, kernel_size=1)
        ...
        self.final_mapping = nn.Conv3d(base_features, in_channels, kernel_size=1)
